...
public class Post6 {
    ...
    /**扫码支付*/
    public void Http_scan(final Wmslbjb_jiezhang mItem, final String mBm, final String nr, final String mPad, final String mID, final String ZFBID,final String payStytle){
